  ...
  <div class="container-wrap">
    <div class="atendimentos_holder grids two_grids">
      ...
      <div class="atendimentos--item">
        <div class="title-container">
          <h1 class="title-tiny"><?php the_field('titulo_politica_e_atendimento', 335); ?></h1>
          <p class="text-small"><?php the_field('descricao_politica_e_atendimento', 335); ?></p>
        </div>
        <?php if(!is_page('85')): ?>
        <div class="conteudo">
